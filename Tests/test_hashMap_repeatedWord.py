import pytest
from CC.hashTables.hashMap_repeatedWord import repeated_word


def test_repeated_word_ex1():
    input_string = "Once upon a time, there was a brave princess who..."
    assert repeated_word(input_string) == "a"


def test_repeated_word_ex2():
    ...
    assert repeated_word(input_string) == "it"


def test_repeated_word_ex3():
    ...
    assert repeated_word(input_string) == "summer"
